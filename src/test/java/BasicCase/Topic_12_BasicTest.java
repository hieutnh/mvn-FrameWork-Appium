...
public class Topic_12_BasicTest {
	AppiumDriver driver;
	...
	public void BeforeClass() throws Exception {
		...
		caps.setCapability("platformName", "BasicCase");
		...
		String apkFile = System.getProperty("user.dir") + File.separator + "APK" + File.separator + "BasicCase.SauceLabs.apk";
