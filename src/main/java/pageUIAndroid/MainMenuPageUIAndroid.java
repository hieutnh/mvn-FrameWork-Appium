...
public class MainMenuPageUIAndroid {
	public static final String 	FILTER_BUTTON = "//1android.view.ViewGroup[@content-desc=\"test-Modal Selector Button\"]/android.view.ViewGroup/android.view.ViewGroup/android.widget.ImageView";
